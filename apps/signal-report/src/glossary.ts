...
export const GLOSSARY = {
  lcp: {
    ...
    cmo: 'Slow LCP is the #1 reason Google lowers your Landing Page Experience score, which raises CPC and shrinks ad reach. Meta uses similar signals on placements that link out to your site.'
  },
  fcp: {
    name: 'FCP',
    ...
    cmo: 'A late FCP is the moment ad clicks start bouncing before they ever became sessions. The cost was already paid; the conversion never had a chance.'
  },
  inp: {
    name: 'INP',
    ...
    cmo: 'Slow interaction is where forms stall and CTAs feel mushy. It directly suppresses conversion at the bottom of the funnel — same ad spend, fewer leads.'
  },
  ttfb: {
    name: 'TTFB',
  ...
  qs: {
    ...
    cmo: 'A slow LCP drops Landing Page Experience by a tier and pulls Quality Score down with it. The auction bills the difference back to you as higher CPC.'
  },
  roas: {
    name: 'ROAS',
    long: 'Return on Ad Spend',
    plain: 'Revenue divided by ad spend. The headline efficiency number for paid media.',
    cmo: 'Slow landings drag ROAS in two ways: more bounces (lost intent) and inflated CPC (paying more per click that left). Both compound.'
  },
  cac: {
    name: 'CAC',
    long: 'Customer Acquisition Cost',
    plain: 'Total spend to acquire one customer.',
    cmo: 'Every percentage point of bounce caused by slow loading lands in CAC. The click was paid for; the customer never existed.'
  },
  cpc: {
    name: 'CPC',
    long: 'Cost per Click',
    plain: 'What you pay each time someone clicks your ad.',
    cmo: 'A worse Landing Page Experience tier raises CPC by single-digit percentages on Google paid search. Compounds across every campaign and every keyword.'
  },
  cpa: {
    name: 'CPA',
    long: 'Cost per Acquisition',
    plain: 'Total cost to drive one conversion (lead, signup, sale).',
    cmo: 'Inflated CPC + reduced conversion rate from slow pages → CPA goes up while spend stays the same.'
  },
  poor: {
    name: 'Poor threshold',
  ...
  renderdelay: {
    ...
    cmo: 'When this dominates, third-party tags and scripts are eating your landing page. The pattern is rarely "buy more bandwidth" — it is "ship less script".'
  }
